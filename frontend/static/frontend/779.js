...
`,p=({padding:e,border:t,children:n})=>a.createElement(m,{padding:e,border:t},n),h=({src:e,width:t,height:i})=>a.createElement("img",{src:n(66073)(`./${e}`),alt:e,with:t,height:i}),u=c.ZP.div`
...
`,g=()=>a.createElement(u,{onClick:()=>{document.getElementById("intro").scrollIntoView({behavior:"smooth",block:"end",inline:"nearest"})}},a.createElement(h,{src:"scroll-top.svg",width:"26px",height:"26px"}));var x=n(96084),f=n(1635),b=n(46699),E=n(98367);const w=c.ZP.button`
...
`,y=({color:e,width:t,children:n,onClick:i})=>a.createElement(w,{color:e,width:t,onClick:i},n),v=c.ZP.section`
  position: relative;
...
`,L=c.ZP.div`
  border-radius: 3rem;
  max-width: 400px;
`,O=(0,b.Z)()((({title:e,content:t,t:n})=>a.createElement(T,null,a.createElement(E.ZP,{left:!0},a.createElement("h6",null,n(e)),a.createElement(L,null,a.createElement(z,null,n(t))))))),I=c.ZP.div`
...
`,q=(0,b.Z)()((({id:e,name:t,placeholder:n,onChange:i,t:r})=>a.createElement(I,null,a.createElement("label",{htmlFor:t},r(e)),a.createElement($,{spellcheck:"false",placeholder:r(n),name:t,id:t,onChange:i})))),D=c.ZP.div`
  display: inline-block;
  width: 100%;
  padding: 10px 5px;
...
`,_=(0,b.Z)()((({name:e,id:t,placeholder:n,onChange:i,t:r})=>a.createElement(D,null,a.createElement("label",{htmlFor:e},r(t)),a.createElement(V,{spellcheck:"false",placeholder:r(n),id:e,name:e,onChange:i})))),A=c.ZP.div`
  padding: 5rem 0;
`,J=c.ZP.section`
  position: relative;
  width: 100%;
